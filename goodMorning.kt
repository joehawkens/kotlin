fun main() {
    ...
    // explicitly declared, such as var name = "Joe" - will be assumed to be a string. Another example would be
    // var boolean = true. The compiler assumes that this is a boolean value and doesn't question further - however, errors
